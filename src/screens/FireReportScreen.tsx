...
export default function AccidentReportScreen({ navigation }: any) {
  ...
  const submitReport = () => {
    ...
    Alert.alert(
      "Report Submitted",
      "Your Accident report has been sent to the Command Center.",
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Accident Report</Text>
      </View>

      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <TouchableOpacity style={styles.reportButton} onPress={openReportForm}>
          <Text style={styles.reportButtonText}>+ Report New Accident</Text>
        </TouchableOpacity>

        <Text style={styles.sectionTitle}>Recent Accidents</Text>

        <View style={styles.recentCard}>
          <Text style={styles.recentTitle}>Collision at Westfield Junction</Text>
          <Text style={styles.recentInfo}>15 mins ago • 2 Vehicles</Text>
        </View>

        <View style={styles.recentCard}>
          <Text style={styles.recentTitle}>Hit and Run near Serrekunda</Text>
          <Text style={styles.recentInfo}>2 hours ago</Text>
        </View>
      </ScrollView>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>Report Accident</Text>
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData({ ...formData, vehiclesInvolved: text })}
            />
            ...
            <TouchableOpacity style={styles.publishButton} onPress={submitReport}>
              <Text style={styles.publishButtonText}>Submit Accident Report</Text>
            </TouchableOpacity>
